...
key_raw = '(1, 9, 4) (4, 2, 8) (4, 8, 3) (7, 1, 5) (8, 10, 1)'

key = key_raw.split(') (').map { |tuple| tuple.gsub(/[()]/,'').split(', ').map(&:to_i) }
...
key.each do |para, line, word|
  puts book[para-1][line-1][word-1]
end